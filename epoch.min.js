...
g.shift();if(0===g.length){n[b]=e;this.trigger("option:"+a);break}null==n[b]&&(n[b]={});n=n[b]}};a.prototype._setManyOptions=function(a,e){var g,b,d;null==e&&(e="");d=[];for(g in a)b=a[g],Epoch.isObject(b)?d.push(this._setManyOptions(b,""+(e+g)+".")):d.push(this._setOption(e+g,b));return d};a.prototype.option=function(){if(0===arguments.length)return this._getAllOptions();if(1===arguments.length&&Epoch.isString(arguments[0]))return this._getOption(arguments[0]);if(2===arguments.length&&Epoch.isString(arguments[0]))return this._setOption(arguments[0],
...
(function(){var f={}.hasOwnProperty,h=function(c,a){function d(){this.constructor=c}for(var b in a)f.call(a,b)&&(c[b]=a[b]);d.prototype=a.prototype;c.prototype=new d;c.__super__=a.prototype;return c};Epoch.Time.Bar=function(c){function a(c){var b;this.options=null!=c?c:{};null==(c=this.options).type&&(c.type="time.bar");this.padding=null!=(b=this.options.padding)?b:2;a.__super__.constructor.call(this,this.options)}h(a,c);a.prototype._offsetX=function(){return 0.5*this.w()/this.pixelRatio};a.prototype.setStyles=
function(a){a=this.getStyles("rect.bar."+a.replace(/\s/g,"."));this.ctx.fillStyle=a.fill;this.ctx.strokeStyle=null==a.stroke||"none"===a.stroke?"transparent":a.stroke;if(null!=a["stroke-width"])return this.ctx.lineWidth=a["stroke-width"].replace("px","")};a.prototype.draw=function(c){var b,k,e,g,f,h,s,m,r,q,p,t,u;null==c&&(c=0);this.clear();g=[this.y(),this.w()];q=g[0];r=g[1];u=this.getVisibleLayers();p=0;for(t=u.length;p<t;p++)if(s=u[p],0<s.values.length)for(this.setStyles(s.className),f=[this.options.windowSize,
s.values.length,this.inTransition()],g=f[0],h=f[1],f=(m=f[2])?-1:0;--g>=f&&0<=--h;)b=s.values[h],e=[g*r+c,b.y,b.y0],b=e[0],k=e[1],e=e[2],m&&(b+=r),b=[b+1,q(k+e),r-this.padding,this.innerHeight()-q(k)+0.5*this.pixelRatio],this.ctx.fillRect.apply(this.ctx,b),this.ctx.strokeRect.apply(this.ctx,b);return a.__super__.draw.call(this)};return a}(Epoch.Time.Stack)}).call(this);
